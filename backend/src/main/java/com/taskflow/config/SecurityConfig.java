...
import com.taskflow.security.RestSecurityErrorWriter;
...
/**
 * 无状态 JWT 安全配置：
 * - 注册/登录、文档、健康检查、H2 控制台放行，其余一律要求登录；
 * - 401/403 统一 JSON；
 * - 前后端分离，禁用 Session 与 CSRF。
 */
@Configuration
@EnableWebSecurity
public class SecurityConfig {
    ...
    public SecurityConfig(JwtAuthFilter jwtAuthFilter, RestSecurityErrorWriter securityErrorWriter) {
